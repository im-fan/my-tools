package com.my.util.mq.support.rocket;
...
import com.my.util.mq.support.rocket.impl.RocketMqFactoryImpl;
...
/**
 * ONS客户端工厂类，用来创建客户端对象
 * com.aliyun.openservices.ons.api.ONSFactory
 */
public class RocketMqFactory {


    private static ONSFactoryAPI onsFactory = new RocketMqFactoryImpl();
